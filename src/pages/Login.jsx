          ...
          <div className="inline-flex items-center justify-center w-16 h-16 bg-white rounded-lg mb-4">
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M12 4.354a4 4 0 110 5.292M15 12H9m4 8H8a4 4 0 01-4-4V8a4 4 0 014-4h8a4 4 0 014 4v8a4 4 0 01-4 4z"
              />
            </svg>
          </div>
          <h1 className="text-3xl font-bold text-white">HRMS</h1>
          <p className="text-blue-100 text-sm mt-2">Human Resource Management System</p>
        </div>
